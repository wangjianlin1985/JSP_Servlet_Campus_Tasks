...
TH {
	...
	<body>
		<table style="width: 100%;height: 70%;" cellspacing="0" cellpadding="0">
			<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="16" background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											<img src="${pageContext.request.contextPath}/images/mis_05a.jpg"
												width="6" height="18">
										</td>
										<td width="155" valign="bottom" background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											管理员：${admin.username }
											<font color="blue"><a href="${pageContext.request.contextPath }/user?method=logout">退出</a></font>
